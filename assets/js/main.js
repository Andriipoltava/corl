...
checkbutton.addEventListener('click', function(e){
    ...
    var changesavings = document.getElementById("savingsnumber").innerHTML = myChart.data.datasets[2].data[24].toLocaleString('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 0, maximumFractionDigits: 0 });
